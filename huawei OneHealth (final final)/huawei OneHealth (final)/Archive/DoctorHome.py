...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.borrow_heroImage_2.setStyleSheet("background-image: url(:/Assets/assets/Payment.jpg);")
...
"")
        ...
        self.yo = QtWidgets.QLabel(self.tab_Search)
        self.yo.setGeometry(QtCore.QRect(0, 0, 1061, 631))
        self.yo.setStyleSheet("background-image: url(:/Assets/assets/Payment.jpg);\n"
"")
        self.yo.setText("")
...
"color: rgb(255, 255, 255);")
        ...
        #search button
        self.search_searchBtn.clicked.connect(lambda: self.displayPatients())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_20.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; color:#000000;\">Search Patient</span></p></body></html>"))
    ...
    def load_consultations(self,docId):
        my_cursor.execute("SELECT consultationId, patient.patientId, patient.name, consultation.remarks "
                          ...
                          "WHERE (doctorId = %s AND datetime < NOW())",('139da82b-eebe-4391-9',))
